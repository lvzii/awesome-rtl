...
| ChipVerilog  | RTL generatation         | ip/core                        | HKUST      | [2026.7-ChipVerilog](https://arxiv.org/html/2607.13079v1)                                                                                         | -                                                                                                                              |           |                                            |
...
| [pyslang](https://github.com/MikePopoloski/pyslang)      | SystemVerilog解析器                         | SystemVerilog解析器      | 代码分析、工具开发 |
| [pyuvm](https://github.com/pyuvm/pyuvm)                  | UVM仿真框架                                 | Python实现的UVM          | Python驱动仿真     |
